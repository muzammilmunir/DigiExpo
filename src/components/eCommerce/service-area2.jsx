            ...
            <div className="tp-service-2__area p-relative pt-70 padding-bottom">
               ...
               <div className="container z-index-5">
                  ...
                  <div className="row gx-60">
                        <div className="col-xl-3 col-lg-3 col-md-6 mb-40 wow tpfadeUp" 
                        ...
                        <div className="tp-service-2__item-wrapper p-relative">
                           <div className="tp-service-2__item d-flex justify-content-between flex-column">
                              ...
                              <div className="tp-service-2__text">
                                 <h4 className="tp-service-2__title-sm ecomm"><Link href="/service-details">Requirement<br/>Analysis</Link></h4>
                        ...
                        <div className="tp-service-2__item-wrapper p-relative">
                           <div className="tp-service-2__item d-flex justify-content-between flex-column">
                              ...
                              <div className="tp-service-2__text">
                                 <h4 className="tp-service-2__title-sm ecomm"><Link href="/service-details">Design &<br/> Development</Link></h4>
                                 <Link className="tp-service-2__link" href="/service-details">Explore
                                    <i className="far fa-arrow-right"></i>
                                 </Link>
                              </div>
                        ...
                        <div className="tp-service-2__item-wrapper p-relative">
                           <div className="tp-service-2__item d-flex justify-content-between flex-column">
                              ...
                              <div className="tp-service-2__text">
                                 <h4 className="tp-service-2__title-sm ecomm"><Link href="/service-details">Integration &<br/> Setup</Link></h4>
                                 <Link className="tp-service-2__link" href="/service-details">Explore
                                    <i className="far fa-arrow-right"></i>
                                 </Link>
                              </div>
                        ...
                        <div className="tp-service-2__item-wrapper p-relative">
                           <div className="tp-service-2__item d-flex justify-content-between flex-column">
                              ...
                              <div className="tp-service-2__text">
                                 <h4 className="tp-service-2__title-sm ecomm"><Link href="/service-details">Testing &<br/> Launch</Link></h4>
                                 <Link className="tp-service-2__link" href="/service-details">Explore
                                    <i className="far fa-arrow-right"></i>
                                 </Link>
                              </div>
